...
const Navbar = () => {
   ...
   return (
    <nav className="flex border-1 z-20 mx-auto px-10 items-center justify-between h-24 max-w-[1728px]">
        <Link href="/">
            <Image src="/logo.svg" alt="logo" width={61} height={24}/>
        </Link>
        <ul className="hidden lg:flex">
            <li href="/" className="p-4">Home</li>
            <li href="/" className="p-4">About Us</li>
            <li href="/" className="p-4">Services</li>
            <li href="/" className="p-4">Blog</li>
        ...
        <div className={!nav ? "fixed left-0 top-0 w-[60%] border-r border-r-yellow h-full bg-lightYellow ease-in-out duration-300": "fixed left-[-100%]"}>
        <Link href="/">
